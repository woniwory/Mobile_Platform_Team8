...
class SurveyProvider extends ChangeNotifier {
  ...
  void addQuestion(BuildContext context) {
    ...
    Future.delayed(Duration.zero, () {
      ...
      FocusScope.of(context).requestFocus(SurveyPage.questionFocusNode);
    });
...
class SurveyPage extends StatelessWidget {
  // questionController에 할당될 포커스 노드 생성
  static final questionFocusNode = FocusNode();
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          style: TextStyle(fontSize: 16.0), // 폰트 크기 작게 조정
                          maxLines: 1,
                          focusNode: questionFocusNode, // 포커스 노드 할당
                        ),
                      ),
                      SizedBox(height: 4.0), // 변경: 위젯 간격 줄임
