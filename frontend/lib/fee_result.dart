...
class _PaymentStatusBodyState extends State<PaymentStatusBody> {
  ...
  final url = 'http://localhost:8080/api/user-surveys/1';
  ...
  if (response.statusCode == 200) {
    ...
    return UserSurvey.fromJson(json.decode(utf8.decode(response.bodyBytes)));
  } else {
...
class _PaymentItemState extends State<PaymentItem> {
  ...
  Future<void> _fetchFeeStatus() async {
    ...
    final url = 'http://localhost:8080/api/user-surveys/fee-status/1/2';
